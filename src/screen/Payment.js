  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.top}>
        <Text style={styles.texts}>Payment Successful</Text>
        <Text>
      ...
      <View style={styles.image}>
        <Image style={styles.img} source={require("../../assets/Successful.png")} />
      </View>
      <View style={styles.button}>
        <TouchableOpacity style={[styles.btn, styles.btn_shadow]}>
